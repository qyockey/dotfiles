...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift" }, "t", function () awful.spawn.with_shell("~/applications/thunderbird/thunderbird") end,
    ...
    awful.key({ modkey, "Shift" }, "Return", function ()
        awful.util.spawn("rofi -modi drun, run -show drun") end,
        {description = "application launcher", group = "launcher"}),
    -- configs 
    awful.key({ modkey, "Shift" }, "c", function ()
        awful.spawn.with_shell("~/.rofi-scripts/config-selector.sh") end,
...
awful.spawn.with_shell("xinput --set-prop 'SYNA7DB5:00 06CB:7DB7 Touchpad' 'libinput Natural Scrolling Enabled' 1 &")
awful.spawn.with_shell("xinput --set-prop 'SYNA7DB5:00 06CB:7DB7 Touchpad' 'libinput Accel Speed' .4 &")
awful.spawn.with_shell("xinput --set-prop 'SYNA7DB5:00 06CB:7DB7 Touchpad' 'libinput Tapping Enabled' 1 &")
